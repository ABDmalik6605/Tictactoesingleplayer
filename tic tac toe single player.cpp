...
//            text1.setString("Hard Luck! but you played well");
//            window.draw(text1);
//        }
//        else
//        {
//        	text1.setFillColor(sf::Color::Blue);
//            text1.setString("Congratulations!You have won");
//            window.draw(text1);
//        }
//    }
//	bool checkwinforuser(sf::RenderWindow& window)
//    {
//    	for (int i=0;i<3;i++)
//    	{
//    		if (r[0][i].p == 2 && r[1][i].p == 2 && r[2][i].p == 2)
//    			return true;
//    	}
//        for (int i=0;i<3;i++)
//    	{
//    		if (r[i][0].p == 2 && r[i][1].p == 2 && r[i][2].p == 2)
//    			return true;
//        }
//        if (r[0][0].p == 2 && r[1][1].p == 2 && r[2][2].p == 2)
//        {
//            return true;
//        }
//        if (r[0][2].p == 2 && r[1][1].p == 2 && r[2][0].p == 2)
//        {
//            return true;
//        }
//        else
...
//        }
//    }
//    bool checkwinforcomp(sf::RenderWindow& window)
//    {
//    	for (int i=0;i<3;i++)
//    	{
//    		if (r[0][i].p == 1 && r[1][i].p == 1 && r[2][i].p == 1)
//    			return true;
//    	}
//        for (int i=0;i<3;i++)
//    	{
//    		if (r[i][0].p == 1 && r[i][1].p == 1 && r[i][2].p == 1)
//    			return true;
//        }
//        if (r[0][0].p == 1 && r[1][1].p == 1 && r[2][2].p == 1)
//        {
//            return true;
//        }
//        if (r[0][2].p == 1 && r[1][1].p == 1 && r[2][0].p == 1)
//        {
//            return true;
//        }
//        else
...
//        }
//    }
//    void compturn(sf::RenderWindow& window)
//    {
//    	bool W =0;int a=0;
...
//    			{
//  	    			r[i][j].p=1;
//	    			W=checkwinforcomp(window);
//	   				r[i][j].p=2;
//	    			W=checkwinforuser(window);
//	   				r[i][j].p=-1;
//				}
//			}
//		}
